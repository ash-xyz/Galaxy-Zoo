...
def load_train_data():
    ...
    # Training Generator
    train_generator = generator.flow_from_dataframe(dataframe=train_data, directory=TRAIN_IMAGES_DIR, x_col="GalaxyID", y_col=CLASSES, subset="training", batch_size=32, seed=42,
                                                    shuffle=True,
                                                    class_mode="raw",
                                                    target_size=(256, 256))
    # Validation Generator
    validation_generator = generator.flow_from_dataframe(dataframe=train_data, directory=TRAIN_IMAGES_DIR, x_col="GalaxyID", y_col=CLASSES, subset="validation", batch_size=32, seed=42,
                                                         shuffle=True,
                                                         class_mode="raw",
                                                         target_size=(256, 256))
